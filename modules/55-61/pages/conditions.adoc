...
+
* Требования к xref:dev@install-linux::requirements-software.adoc[программному] обеспечению.
* Требования к xref:dev@install-linux::requirements-hardware.adoc[техническому] обеспечению.
* Требования к xref:dev@install-linux::requirements-database.adoc[СУБД].
+
include::dev@platform:admin:pre-config-server.adoc[tags=preconfig]