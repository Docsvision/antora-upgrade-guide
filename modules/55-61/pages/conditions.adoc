...
+
* Требования к xref:6.1@install-linux::requirements-software.adoc[программному] обеспечению.
* Требования к xref:6.1@install-linux::requirements-hardware.adoc[техническому] обеспечению.
* Требования к xref:6.1@install-linux::requirements-database.adoc[СУБД].
+
