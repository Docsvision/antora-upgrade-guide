...
====
+
Для сервисов {dv} на сервере Linux под управлением Astra Linux при обновлении будет предложено перезаписать текущий конфигурационный файл `appsettings.json`.
+
.Доступные варианты:
[%collapsible]
====
...
[NOTE]
====
* Машины с серверными компонентами {dv} под управлением Windows, включая машины с {pu} и {kvr}, также обновите до {net-r}.
====
+
